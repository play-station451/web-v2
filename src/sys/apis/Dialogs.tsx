        ...
        <div className="fixed inset-0 z-999999999 flex flex-col items-center justify-center bg-[#00000078] backdrop-blur-xs duration-150" ref={container}>
            <div ref={dialog} className="flex flex-col p-2.5 gap-2.5 backdrop-blur-md rounded-lg sm:min-w-[340px] md:min-w-[400px] lg:min-w-[600px] bg-[#ffffff18] text-white shadow-tb-border-shadow duration-150">
                ...
                <div className="flex justify-between">
                    <button className="p-2 text-[#ffffff78] cursor-pointer hover:text-white duration-150" onMouseDown={Cancel}>Cancel</button>
                    <button className="flex gap-1.5 w-max py-2 px-5 rounded-md cursor-pointer bg-[#86ff9085] shadow-[0px_0px_6px_0px_#00000052,_inset_0_0_0_0.5px_#ffffff38] hover:bg-[#8fff98a2] duration-150" onMouseDown={OK}>OK</button>
                </div>
            </div>
        </div>
                ...
                <div className="grid grid-cols-4 gap-2">
                    {
                        options && options.map((option: { text: string; value: string }) => (
                            <button key={option.value} className="py-1.5 px-2.5 rounded-md bg-[#ffffff10] hover:bg-[#ffffff28] shadow-tb-border-shadow duration-150 cursor-pointer" onMouseDown={() => OK(option.value)}>{option.text}</button>
                        ))
                    }
                </div>
            </div>
        ...
        <div className="fixed inset-0 z-999999999 flex flex-col items-center justify-center bg-[#00000078] backdrop-blur-xs duration-150" ref={container}>
            <div ref={dialog} className="flex flex-col p-2.5 gap-2.5 backdrop-blur-md rounded-lg sm:min-w-[340px] md:min-w-[400px] lg:min-w-[600px] bg-[#ffffff18] text-white shadow-tb-border-shadow duration-150">
                ...
                <input
                    ...
                    className="p-2 pl-4 rounded-lg bg-[#ffffff20] cursor-text outline-hidden shadow-tb-border-shadow duration-150"
                    style={{ width: '100%' }}
                    ref={passwordRef}
                    onKeyDown={onDown}
                />
        ...
        <div className="fixed inset-0 z-999999999 flex flex-col items-center justify-center bg-[#00000078] backdrop-blur-xs duration-150">
            <div className="flex flex-col p-2.5 gap-2.5 backdrop-blur-md rounded-lg sm:min-w-[340px] md:min-w-[400px] lg:min-w-[600px] bg-[#ffffff18] text-white shadow-tb-border-shadow duration-150">
                ...
                <div className="flex justify-between">
                    <button className="p-2 text-[#ffffff78] cursor-pointer hover:text-white duration-150" onMouseDown={Cancel}>Cancel</button>
                    {showBackButton && (
                        <button className="dialog-button goBack-button cursor-pointer" onMouseDown={() => { const parts = currentDirectory.split('/'); parts.pop(); const inp = parts.join('/') + '/'; setCurrentDirectory(inp)}}>Go Back</button>
                    )}
                    <button className={`${selectedEntry ? 'flex gap-1.5 w-max py-2 px-5 rounded-md cursor-pointer bg-[#86ff9085] shadow-[0px_0px_6px_0px_#00000052,_inset_0_0_0_0.5px_#ffffff38] hover:bg-[#8fff98a2] duration-150' : 'flex gap-1.5 w-max py-2 px-5 rounded-md cursor-pointer bg-[#ffffff10] shadow-[0px_0px_6px_0px_#00000052,_inset_0_0_0_0.5px_#ffffff38] hover:bg-[#ffffff18] duration-150'}`} onMouseDown={OK} disabled={!selectedEntry}>Select</button>
                </div>
            </div>
        </div>
    )
            ...
            <div className="flex flex-col p-2.5 gap-2.5 backdrop-blur-md rounded-lg sm:min-w-[340px] md:min-w-[400px] lg:min-w-[600px] bg-[#ffffff18] text-white shadow-tb-border-shadow duration-150">
                ...
                <div className="flex justify-between">
                    ...
                    <button className={`
                        ...
                        `} onMouseDown={Select} disabled={!selectedEntry}>Select</button>
                </div>
            </div>
        </div>
    )
                        ...
                        {fileEntries.length === 0 ? (
                            ...
                            fileEntries.map(({ entry, isDirectory }) => (
                                <div
                                    ...
                                    data-entry={entry}
                                    className="file-item flex gap-2 items-center select-none p-1.5 first:rounded-t-lg last:rounded-b-lg duration-150"
                                    onMouseDown={() => Select(entry, isDirectory)}
                                >
                                    <div className="flex gap-2 items-center">
                                        {isDirectory ? (
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="size-10 pointer-events-none">
    ...
    return (
        <div className="fixed inset-0 z-999999999 flex flex-col items-center justify-center bg-[#00000078] backdrop-blur-xs duration-150">
            <div className="flex flex-col p-2.5 gap-2.5 backdrop-blur-md rounded-lg sm:min-w-[340px] md:min-w-[400px] lg:min-w-[600px] bg-[#ffffff18] text-white shadow-tb-border-shadow duration-150">
                ...
                <div className="flex justify-between">
                    <button className="p-2 text-[#ffffff78] cursor-pointer hover:text-white duration-150" onMouseDown={Cancel}>Cancel</button>
                    <button className="flex gap-1.5 w-max py-2 px-5 rounded-md cursor-pointer bg-[#86ff9085] shadow-[0px_0px_6px_0px_#00000052,_inset_0_0_0_0.5px_#ffffff38] hover:bg-[#8fff98a2] duration-150" onMouseDown={onSave}>Save</button>
                </div>
            </div>
        </div>
    )
