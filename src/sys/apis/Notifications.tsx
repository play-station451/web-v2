        ...
        <div className={`flex flex-col shadow-tb-border-shadow bg-[#00000088] rounded-lg backdrop-blur-lg fade-in`}>
            ...
            <div className="flex flex-col gap-2 p-2.5">
                ...
                <div className="flex gap-2 justify-between">
                    <button className="leading-none p-2.5 px-4 bg-[#ffffff20] shadow-tb-border rounded-md hover:bg-[#ffffff30] duration-150 cursor-pointer" onClick={Cancel}>Cancel</button>
                    <button className="leading-none p-2.5 px-4 bg-[#53f67463] shadow-tb-border rounded-md hover:bg-[#53f67473] duration-150 cursor-pointer" onClick={OK}>OK</button>
                </div>
            </div>
        </div>
    )
        ...
        <div className={`flex flex-col shadow-tb-border-shadow bg-[#00000088] rounded-lg backdrop-blur-lg fade-in`}>
            ...
            <div className="flex flex-col gap-2 p-2.5">
                ...
                <div className="relative flex w-full h-3 rounded-full bg-[#00000020] overflow-hidden">
                    {
                        currentAnimation === 0 ? (
                            <div className="absolute h-full bg-[#50bf66] rounded-full" style={{ animation: anim0 }}></div>
                        ) : (
                            <div className="absolute h-full bg-[#50bf66] rounded-full" style={{ animation: anim1 }}></div>
                        )
                    }
                </div>
                <div className="flex gap-2 justify-between">
                    <button className="leading-none p-2.5 px-4 bg-[#53f67463] shadow-tb-border rounded-md hover:bg-[#53f67473] duration-150 cursor-pointer" style={{ position: "sticky", left: "100%" }} onClick={OK}>OK</button>
                </div>
            </div>
        </div>
    )
