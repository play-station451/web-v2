    ...
    return (
        <div className="music-player w-[250px] h-[50px]">
            ...
            <div className="playerctrl gap-2">
                <svg width="16" height="9" onClick={() => {next()}} className="back cursor-pointer" viewBox="0 0 16 9" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <svg width="16" height="9" onClick={() => {back()}} className="forward cursor-pointer" viewBox="0 0 16 9" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M2.17779 0.189122C1.2073 -0.351863 0 0.332324 0 1.42263V7.57727C0 8.66834 1.2073 9.35176 2.17779 8.81078L7.56988 5.8043V7.57727C7.56988 8.66834 8.77717 9.35176 9.74767 8.81078L15.2663 5.73383C16.2446 5.1883 16.2446 3.81235 15.2663 3.26682L9.74767 0.189122C8.77717 -0.351863 7.56988 0.333081 7.56988 1.42263V3.1956L2.17779 0.189122Z" fill="#A4A4A4"/>
                </svg>
            </div>
