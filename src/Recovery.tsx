        ...
        <div className={`overflow-hidden w-full h-full flex justify-center pt-[30px] bg-[#0e0e0e] ${showCursor ? null : "cursor-none"}` }>
            <div className="flex flex-col items-center w-full p-2 text-[#ffffff48] overflow-hidden">
                ...
                <div ref={msgbox} className="hidden mt-1 p-2 flex-col flex-grow overflow-auto w-full border-solid border-[#ffffff68] border-2 rounded-xl z-10">
                    <div className="flex flex-col items-center justify-center h-full">
                        ...
                        <div className="flex mt-4">
                            <button className="mr-2 cursor-pointer bg-[#ffffff0a] text-[#ffffff38] border-[#ffffff22] hover:bg-[#ffffff10] hover:text-[#ffffff8d] focus:bg-[#ffffff1f] focus:text-[#ffffff8d] focus:border-[#73a9ffd6] focus:ring-[#73a9ff74] focus:outline-hidden focus:ring-2 ring-[transparent] ring-0 border-[1px] font-[600] px-[20px] py-[8px] rounded-[6px] duration-150" onClick={() => eval(action)}>Proceed</button>
                            <button className="cursor-pointer bg-[#ffffff0a] text-[#ffffff38] border-[#ffffff22] hover:bg-[#ffffff10] hover:text-[#ffffff8d] focus:bg-[#ffffff1f] focus:text-[#ffffff8d] focus:border-[#73a9ffd6] focus:ring-[#73a9ff74] focus:outline-hidden focus:ring-2 ring-[transparent] ring-0 border-[1px] font-[600] px-[20px] py-[8px] rounded-[6px] duration-150" onClick={() => { setShowCursor(false); msgbox.current!.classList.remove("flex"); msgbox.current!.classList.add("hidden"); main.current!.classList.add("flex"); main.current!.classList.remove("hidden"); }}>Cancel</button>
                        </div>
                    </div>
                </div>
                <div ref={progresscheck} className="hidden bg-[#0e0e0e] h-full justify-center items-center flex-col lg:h-full md:h-full">
                    ...
                    <p ref={statusref} className="mt-1">Downloading...</p>
                ...
                <div ref={main} className="mt-1 p-2 flex flex-col flex-grow overflow-auto w-full border-solid border-[#ffffff68] border-2 rounded-xl">
                    ...
                    <span className={
                        ...
                        setMsg("BE AWARE if your static hosting this download will NOT work. Proceed?");
                        setAction("prodins()")
                    }}>Restore from Production Instance (Beta)</span>
                    <span className={
                        "p-2 px-2.5 text-sm font-extrabold lg:text-lg md:text-base border-[1px] rounded-md" + " " +
                        `
                    ...
                    {updCache && (
                        <span className={
                            ...
                            await (new Filer.fs.Shell()).promises.rm("/system/tmp/terb-upd/", {recursive: true});
                            window.location.reload();
                        }}>Restore from Update Cache</span>
                    )}
                    <span className={
                        "p-2 px-2.5 text-sm font-extrabold lg:text-lg md:text-base border-[1px] rounded-md" + " " +
                        `
                ...
                <span className="font-mono">Press the <span className="text-[#ffffff68] font-sans font-bold">enter</span> key to select.</span>
            </div>
        </div>
    );
}
