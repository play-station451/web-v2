...
export default function Setup() {
    ...
    const Step1 = () => {
        ...
        return (
            <div ref={(el) => {currentViewRef.current = el}} className="duration-150 -translate-x-6 opacity-0 flex flex-col justify-center items-center">
                <div className="text-container relative flex flex-col justify-center items-end">
                    <div className="bg-linear-to-b from-[#ffffff] to-[#ffffff77] text-transparent bg-clip-text flex flex-col lg:items-end md:items-center sm:items-center">
                        <span className="font-[700] lg:text-[34px] md:text-[28px] sm:text-[22px] text-right duration-150">The next generation of <span className="font-[1000] duration-150">Terbium.</span></span>
            ...
            <div ref={(el) => {currentViewRef.current = el}} className="duration-150 -translate-x-6 opacity-0 flex flex-col justify-center items-center">
                <div className="relative flex flex-col justify-center items-end">
                    ...
                    <div className="flex flex-col gap-[10px] justify-center items-center mr-[40px]">
                        <div ref={pfpRef} className="pfp relative group w-[100px] h-[100px] rounded-[50%] bg-[#ffffff0a] border-[#3b3b3b] border-[2px] transition duration-150 ring-[transparent] ring-0 cursor-pointer"
                        onMouseDown={() => {
                                ...
                                uploader.onchange = () => {
                                    ...
                                    reader.onload = () => {
                                        ...
                                        img.onload = () => {
                                            ...
                                            const cropper_container_styles = [
                                                "w-screen", "h-screen", "fixed", "top-0", "left-0", "right-0", "bottom-0", "z-999999",
                                                "bg-[#000000a6]", "flex", "flex-col", "justify-center", "items-center", "gap-[10px]"
                                            ];
                                            ...
                                            let cropper_img_container_sizes = [
                                                "bg-[#ffffff0a]", "lg:w-[500px]", "lg:h-[500px]", "md:w-[400px]", "md:h-[400px]",
                                                "sm:w-[300px]", "sm:h-[300px]", "flex", "justify-center",
                                                "items-center", "rounded-[8px]", "overflow-hidden",
                                            ];
                                            ...
                                            save.innerText = "Save";
                                            const save_styles = [
                                                "bg-[#1d1d1d]", "text-[#ffffff38]", "border-[#ffffff22]", "hover:bg-[#414141]",
                                                "hover:text-[#ffffff8d]", "focus:bg-[#ffffff1f]", "focus:text-[#ffffff8d]",
                                                "focus:border-[#73a9ffd6]", "focus:ring-[#73a9ff74]", "focus:outline-hidden",
                                                "focus:ring-2", "ring-[transparent]", "ring-0", "border-[1px]", "font-[600]",
                                                "px-[20px]", "py-[8px]", "h-[18px]", "rounded-[6px]", "transition", "duration-150"
                                            ];
    ...
    const Step3 = () => {
        ...
        return (
            <div ref={(el) => {currentViewRef.current = el}} className="duration-150 -translate-x-6 opacity-0 flex flex-col justify-center items-center">
                <span className="font-[800] text-[34px] bg-linear-to-b from-[#ffffff] to-[#ffffff77] text-transparent bg-clip-text lg:mb-[20px] md:mb-[20px] sm:mb-[10px] lg:text-[34px] md:text-[28px] sm:text-[22px] duration-150">
                    Choose your default proxy.
                </span>
                        ...
                        <div className="dropdown-options active">
                            {bareOptions.map((option, index) => (
                                <div
                                    ...
                                    key={index}
                                    onMouseDown={() => bClick(option.label)}
                                >
                        ...
                        <div className="dropdown-options active">
                            {transportOptions.map((option, index) => (
                                <div
                                    className="dropdown-option"
                                    key={index}
                                    onMouseDown={() => transportOnClick(option.label)}
                                >
                                    <span className="pointer-events-none">{option.label}</span>
                                </div>
                            ))}
    ...
    const Step5 = () => {
        ...
        return (
            <p ref={(el) => {currentViewRef.current = el}} className="font-[700] text-[28px] duration-150 -translate-x-6 opacity-0">Welcome to Terbium.</p>
        )
    }
